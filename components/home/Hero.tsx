...
export default function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(80rem_40rem_at_top,theme(colors.teal.500/10),transparent_60%)] dark:bg-[radial-gradient(80rem_40rem_at_top,theme(colors.teal.400/12),transparent_60%)]"
      />
      <div className="mx-auto max-w-7xl px-4 pb-16 pt-12 sm:px-6 md:pt-20 md:pb-24 lg:px-8">
        <div className="mx-auto grid max-w-5xl items-center gap-8 text-center md:gap-10">
          ...
          <h1 className="mx-auto max-w-3xl text-balance text-4xl font-semibold tracking-tight sm:text-5xl md:text-6xl">
            Reconnect. Mentor. <span className="text-teal-600 dark:text-teal-400">Grow together.</span>
          </h1>
